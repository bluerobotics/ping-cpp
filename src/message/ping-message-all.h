...
public:
    ...
    static constexpr const char* nameFromMessageId(const PingEnumNamespace::PingMessageId messageId) {
        switch(messageId) {
            ...
            case(PingEnumNamespace::PingMessageId::BLUEBPS_LPF_SETTING):
                return "LPF_SETTING";
            case(PingEnumNamespace::PingMessageId::BLUEBPS_STREAM_RATE):
                return "STREAM_RATE";
            case(PingEnumNamespace::PingMessageId::BLUEBPS_LPF_SAMPLE_FREQUENCY):
                return "LPF_SAMPLE_FREQUENCY";
            case(PingEnumNamespace::PingMessageId::BLUEBPS_CELL_VOLTAGE_TIMEOUT):
                return "CELL_VOLTAGE_TIMEOUT";
            case(PingEnumNamespace::PingMessageId::BLUEBPS_CELL_VOLTAGE_MINIMUM):
                return "CELL_VOLTAGE_MINIMUM";
